...
class JaxProtAngularAlignmentReconSirenHetOnly(ProtAnalysis3D, ProtFlexBase):
    """ Ab initio reconstruction and global assignation with ReconSIREN neural network."""
    _label = 'angular align - ReconSIREN HetOnly'
    ...
    def trainingPredictStep(self):
        ...
        program = hax.Plugin.getProgram("reconsiren_het_only", gpu)
