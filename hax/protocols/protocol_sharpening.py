...
class JaxProtSharpeningHetSiren(ProtAnalysis3D, ProtFlexBase):
    ...
    def trainingPredictStep(self):
        ...
        args = "--md %s --vol %s --sr %f --lat_dim %d --epochs %d --batch_size %d --learning_rate %s --output_path %s --denoising_strength %f " \
               % (md_file, vol_file,  sr, latDim, epochs, batch_size, learningRate, out_path, denoisingStrength)
